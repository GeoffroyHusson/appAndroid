...
/**
 * Created by Geoffroy on 15-02-15.
 */
...
import static com.example.geoffroy.myapp.Utils.Utilities.inputStreamToString;;

/**
 * Classe servant à faire une requête en post sur le réseau.
 * Attention, un adapter doit être resté après une requête pour être réutilisé.
 * Des observateurs peuvent s'enregistrer sur cette classe pour être prévenu une fois la
 * réponse à la requête obtenue.
 * @author peri
 *
 */
